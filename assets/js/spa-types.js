  ...
  if (dt_category_list_table.length) {
    ...
    ajax: assetsPath + 'json/categories.json', // JSON file to add data
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/pages/spa/view.html?id='+full['id']+'" class="btn btn-sm btn-icon"><i class="ti ti-edit"></i></a>' +
              '</div>'
            );
          }
        }
      ...
      language: {
        sLengthMenu: '_MENU_',
        search: '',
        searchPlaceholder: 'Rechercher type établissement'
      },
      // Button for offcanvas
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Ajouter type</span>',
