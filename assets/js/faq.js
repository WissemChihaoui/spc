...
$(function () {
  ...
  var dt_faq_datatable = $('.datatables-faq-list');

  // Customers List Datatable

  if (dt_faq_datatable.length) {
    var dt_faq = dt_faq_datatable.DataTable({
      ajax: assetsPath + 'json/faq.json', // JSON file to add data
      columns: [
      ...
      language: {
        sLengthMenu: '_MENU_',
        search: '',
        searchPlaceholder: 'Recherche question'
      },
      // Button for offcanvas
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Ajouter question</span>',
